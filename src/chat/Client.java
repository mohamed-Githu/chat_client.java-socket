...
public class Client extends javax.swing.JFrame {
            ...
            while(true) {
                ...
                switch(msg.getType()) {
                    case "MESSAGE":
                        ...
                        break;
                    case "CONFIRM_USER":
                        confirmUserName(msg.getAuther());
                        break;
                    case "DENY_USER":
                        jTextField2.setText("UserName already exicts!");
                        break;
                    case "CLEAR_CHAT":
                        clearChat();
                        break;
    ...
    public void setUserName() {
        ...
        try {
            out.writeObject(new Message("SET_USER_NAME", name));
        } catch(Exception ex) { System.out.println(ex); }
    }
    ...
    public void buzz() {
        for (int x = 0; x < 10; x++)
            jTextArea1.append("Buzz: buzzzzzzzzzzz\n");
    }
